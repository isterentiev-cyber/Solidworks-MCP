...
- **Чертежи**: виды (`add_drawing_view`/`add_section_view`/`add_detail_view`,
  `add_broken_out_section`, `move_drawing_view`, `delete_drawing_view`) и аннотации
  ...
  **Тело вращения на чертеже — один вид сбоку + `add_broken_out_section`**
  (глубина = наружный радиус, по умолчанию), а не вид с торца + разрез А-А.
